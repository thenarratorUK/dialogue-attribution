...
# ========= STEP 3: Speaker Color Assignment =========
    ...
    if "speaker_colors" in st.session_state and st.session_state.speaker_colors:
        ...
        if col1.button("Continue"):
            ...
            auto_save()
            st.rerun()
        if col2.button("Edit Speaker Colors"):
            del st.session_state.speaker_colors
            st.rerun()
    else:
        st.write("Assign highlight colors for speakers that do not yet have an assigned color.")
